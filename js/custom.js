$(document).ready(function() {
   ...
   $('.redirect_btn').click(function(event) {
      ...
      // Calculate the target offset (reduce the scroll height by 100 pixels)
   ...
   $('#pricingSection ul li a').click(function (event) {
      ...
      $('.mixer').removeClass('active');
      $('.mixer').removeClass('mixitup-control-active');

      // Add the 'active' class to the target tab
      $('#' + targetTabId).addClass('active');
      $('#' + targetTabId).addClass('mixitup-control-active');
  });
